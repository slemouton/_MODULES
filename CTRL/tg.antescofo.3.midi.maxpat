...
,
		"classnamespace" : "box",
		"rect" : [ -1635.0, 53.0, 1197.0, 1027.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"id" : "obj-27",
					"items" : [ "Akk1.asco", ",", "Akk1.asco copy", ",", "Akk1_midi_simulation.asco", ",", "MIDI", ",", "Old", ",", "Tests" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					...
					"prefix" : "~/Projets/Co/Gualandi/WeAreNotTheWaves/Wantw/data/ANTESCOFO/",
					"presentation" : 1,
