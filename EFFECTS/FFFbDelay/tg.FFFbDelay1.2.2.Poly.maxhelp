...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 18.0, 77.0, 223.0, 98.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 18.0, 218.0, 161.0, 31.0 ],
					"text" : "poly~ tg.FFFbDelay1.2.2.poly 1 args 1FFB",
					"varname" : "poly~"
				}
...
, 			{
				"name" : "tg.FFFbDelay1.2.2.poly.maxpat",
				"bootpath" : "~/Desktop/_MODULES-master/EFFECTS/FFFbDelay",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
