...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 18.0, 76.0, 226.0, 94.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 18.0, 218.0, 155.0, 31.0 ],
					"text" : "poly~ tg.FFFbDelay.2.2.poly 1 args 1FFB",
					"varname" : "poly~"
				}
...
, 			{
				"name" : "tg.FFFbDelay.2.2.maxpat",
				"bootpath" : "~/Desktop/_MODULES-master/EFFECTS/FFFbDelay",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "tg.FFFbDelay.2.2.poly.maxpat",
				"bootpath" : "~/Desktop/_MODULES-master/EFFECTS/FFFbDelay",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
