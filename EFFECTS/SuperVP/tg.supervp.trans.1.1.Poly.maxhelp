...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 185.0, 318.0, 34.0, 18.0 ],
					"text" : "init"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 185.0, 260.5, 34.0, 18.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 185.0, 371.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 185.0, 401.0, 113.0, 31.0 ],
					"text" : ";\r1SVPt Transpose $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 185.0, 336.0, 113.0, 31.0 ],
					"text" : ";\r1SVPt.INIT bang",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 590.0, 105.5, 56.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 185.0, 278.5, 113.0, 31.0 ],
					"text" : ";\r1SVPt.interface open",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 412.0, 81.5, 50.0, 20.0 ],
					"text" : "clear"
				}
...
,
					"patching_rect" : [ 412.0, 254.5, 64.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 386.0, 111.5, 152.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 460.0, 278.5, 19.0, 18.0 ],
					"text" : "ct"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 412.0, 278.5, 48.0, 20.0 ],
					"prototypename" : "Live",
					"triscale" : 0.75
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 412.0, 302.5, 106.0, 31.0 ],
					"text" : ";\r1SVPt Transpose $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 360.0, 107.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 360.0, 139.5, 200.0, 100.0 ],
					"range" : [ 0.0, 1200.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 18.0, 218.0, 171.0, 31.0 ],
					"text" : "poly~ tg.supervp.trans.1.1.Poly 1 args 1SVPt",
					"varname" : "poly~"
				}
...
, 			{
				"name" : "tg.supervp.trans.1.1.Poly.maxpat",
