...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 317.0, 22.0, 220.0, 93.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 128.0, 423.5, 133.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 128.0, 362.5, 109.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 128.0, 311.5, 109.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 305.333344000000011, 487.0, 309.0, 53.0 ],
					"text" : ";\r1conv Dry/wet 100., FilterFreq 1000., FilterGain 0., FilterMode 5., FilterQ 0.3, Ingain1 0., Ingain2 0., Morph 100., Outgain -70., ReceiveEnable 1., ReceiveSource2 none,"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 411.333344000000011, 448.0, 97.0, 31.0 ],
					"text" : ";\r1conv Morph $1"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 18.0, 22.0, 223.0, 93.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "poly~ tg.Convolution.2.1.Poly 1 args 1conv",
					"varname" : "poly~"
				}
...
, 			{
				"name" : "tg.Convolution.2.1.Pfft.maxpat",
				"bootpath" : "~/Desktop/_MODULES-master/EFFECTS/Convolution",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "tg.Convolution.2.1.maxpat",
				"bootpath" : "~/Desktop/_MODULES-master/EFFECTS/Convolution",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
