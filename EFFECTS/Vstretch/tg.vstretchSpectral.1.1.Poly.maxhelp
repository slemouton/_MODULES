...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 18.0, 17.0, 231.0, 92.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 18.0, 206.0, 226.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 126.0, 393.0, 133.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 126.0, 447.0, 133.0, 31.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-14.1::obj-1::obj-79" : [ "Smooth", "Smooth", 0 ],
...
,
			"parameter_overrides" : 			{
				"obj-14.1::obj-1::obj-12" : 				{
					"parameter_longname" : "Dry/wet[1]"
				}
,
				"obj-14.1::obj-1::obj-14" : 				{
					"parameter_longname" : "Outgain[1]"
				}
,
				"obj-14.1::obj-1::obj-23" : 				{
					"parameter_longname" : "Vstretch[1]"
				}
,
				"obj-14.1::obj-1::obj-32" : 				{
					"parameter_longname" : "Interval[1]"
				}
,
				"obj-14.1::obj-1::obj-41" : 				{
					"parameter_longname" : "Follower[1]"
				}
,
				"obj-14.1::obj-1::obj-42" : 				{
					"parameter_longname" : "FilterMode[1]"
				}
,
				"obj-14.1::obj-1::obj-43" : 				{
					"parameter_longname" : "Sharp[1]"
				}
,
				"obj-14.1::obj-1::obj-47" : 				{
					"parameter_longname" : "Input[1]"
				}
,
				"obj-14.1::obj-1::obj-49" : 				{
					"parameter_longname" : "Mode[1]"
				}
,
				"obj-14.1::obj-1::obj-67" : 				{
					"parameter_longname" : "FilterGain[1]"
				}
,
				"obj-14.1::obj-1::obj-70" : 				{
					"parameter_longname" : "FilterFreq[1]"
				}
,
				"obj-14.1::obj-1::obj-72" : 				{
					"parameter_longname" : "FilterQ[1]"
				}
,
				"obj-14.1::obj-1::obj-8" : 				{
					"parameter_longname" : "Ingain[1]"
				}
,
				"obj-14.1::obj-1::obj-80" : 				{
...
, 			{
				...
				"bootpath" : "~/Desktop/_MODULES-master/EFFECTS/Vstretch",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
