...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 77.0, 50.0, 233.0, 104.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 401.0, 133.0, 31.0 ],
					"text" : ";\r1lim.storage recall Test1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 340.0, 109.0, 31.0 ],
					"text" : ";\r1lim.INIT bang",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 289.0, 109.0, 31.0 ],
					"text" : ";\r1lim.interface open",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "poly~ tg.Limiter.2.2.Poly 1 args 1lim",
					"varname" : "poly~"
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-1.1::obj-4::obj-43" : [ "Input", "Input", 0 ],
			"obj-1.1::obj-4::obj-44" : [ "Meters", "Meters", 0 ],
			"obj-1.1::obj-4::obj-51" : [ "Output", "Output", 0 ],
			"obj-1.1::obj-4::obj-52" : [ "Thresh", "Thresh", 0 ],
			"obj-1.1::obj-4::obj-53" : [ "Mode", "Mode", 0 ],
			"obj-1.1::obj-4::obj-54" : [ "Bypass", "Bypass", 0 ],
			"obj-1.1::obj-4::obj-56" : [ "MetersRate", "MetersRate", 0 ],
...
, 			{
				"name" : "tg.Limiter.2.2.Poly.maxpat",
				"bootpath" : "~/Desktop/_MODULES-master/EFFECTS/Limiter",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "tg.Limiter.2.2.maxpat",
				"bootpath" : "~/Desktop/_MODULES-master/EFFECTS/Limiter",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
