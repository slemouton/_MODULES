...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 26.75, 41.0, 231.0, 101.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 112.0, 412.0, 133.0, 31.0 ],
					"text" : ";\r1rin.storage recall Test1"
				}
...
, 			{
				"box" : 				{
					"addpoints_with_curve" : [ 10.638297, -8.080909, 0, 0.0, 2925.531981999999971, 1000.0, 0, 0.395, 3776.595702999999958, 454.426666000000012, 0, 0.0, 5904.255371000000196, 880.239990000000034, 0, 0.0, 7180.851074000000153, 214.906677000000002, 0, -0.345, 10000.0, 2.0, 0, -0.7 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 18.0, 214.0, 145.5, 31.0 ],
					"text" : "poly~ tg.Ringmod.2.2.Poly 1 args 1rin",
					"varname" : "poly~"
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-1.1::obj-4::obj-33" : [ "Freq", "Freq", 0 ],
			"obj-1.1::obj-4::obj-34" : [ "PRESET", "PRESET", 0 ],
...
, 			{
				"name" : "tg.Ringmod.2.2.Poly.maxpat",
				"bootpath" : "~/Desktop/_MODULES-master/EFFECTS/Ringmod",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "tg.Ringmod.2.2.maxpat",
				"bootpath" : "~/Desktop/_MODULES-master/EFFECTS/Ringmod",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
