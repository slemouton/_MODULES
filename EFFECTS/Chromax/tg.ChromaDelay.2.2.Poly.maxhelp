...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 14.0, 29.0, 235.0, 96.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 18.0, 210.0, 178.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 299.5, 485.0, 38.0, 18.0 ],
					"text" : "interp"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 178.0, 485.0, 33.0, 18.0 ],
					"text" : "gliss"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 301.5, 503.0, 104.0, 42.0 ],
					"text" : ";\r1Chro Flush 1;\r1Chro InterpMode 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 130.5, 503.0, 128.0, 53.0 ],
					"text" : ";\r1Chro Flush 1;\r1Chro Chord 63 64;\r1Chro InterpMode 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 130.5, 612.0, 122.0, 31.0 ],
					"text" : ";\r1Chro Chord 63 64"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 130.5, 566.0, 122.0, 31.0 ],
					"text" : ";\r1Chro Chord 81 83"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 301.5, 608.5, 122.0, 31.0 ],
					"text" : ";\r1Chro Chord 63 64"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 301.5, 556.5, 122.0, 31.0 ],
					"text" : ";\r1Chro Chord 81 83"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 128.0, 373.0, 133.0, 31.0 ],
					"text" : ";\r1Chro.storage recall Test1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.0, 308.0, 25.0, 18.0 ],
					"text" : "Init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 128.0, 325.5, 109.0, 31.0 ],
					"text" : ";\r1Chro.INIT bang",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 128.0, 278.0, 109.0, 31.0 ],
					"text" : ";\r1Chro.interface open",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
,
			"parameter_overrides" : 			{
				"obj-13.1::obj-1::obj-44" : 				{
					"parameter_longname" : "HarmModel[1]"
				}
,
				"obj-13.1::obj-1::obj-46" : 				{
					"parameter_longname" : "Flush[1]"
				}
,
				"obj-13.1::obj-1::obj-53" : 				{
					"parameter_longname" : "Tune[1]"
				}
,
				"obj-13.1::obj-1::obj-60" : 				{
					"parameter_longname" : "ForceFilter[1]"
				}
,
				"obj-13.1::obj-1::obj-66" : 				{
					"parameter_longname" : "ReceiveChord[1]"
				}
,
				"obj-13.1::obj-1::obj-76" : 				{
					"parameter_longname" : "InterpMode[1]"
				}
,
...
,
				"obj-13.1::obj-1::obj-81" : 				{
					"parameter_longname" : "Shift[1]"
				}
,
				"obj-13.1::obj-1::obj-82" : 				{
					"parameter_longname" : "InterpTime[1]"
				}
,
				"obj-13.1::obj-1::obj-83" : 				{
					"parameter_longname" : "Stretch[1]"
				}
,
				"obj-13.1::obj-1::obj-88" : 				{
					"parameter_longname" : "PanR[1]"
				}
,
				"obj-13.1::obj-1::obj-89" : 				{
					"parameter_longname" : "PanL[1]"
				}
