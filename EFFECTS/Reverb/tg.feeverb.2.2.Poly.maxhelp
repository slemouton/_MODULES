...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 18.0, 24.0, 234.0, 97.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.0, 251.0, 41.0, 18.0 ],
					"text" : "Open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 95.0, 417.5, 100.0, 20.0 ],
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.0, 302.0, 25.0, 18.0 ],
					"text" : "Init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 128.0, 320.0, 109.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 535.0, 261.0, 83.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 128.0, 269.0, 109.0, 31.0 ],
...
, 			{
				"box" : 				{
					"addpoints_with_curve" : [ 10.638297, -24.242398999999999, 0, 0.0, 2925.531981999999971, 2400.0, 0, 0.395, 3776.595702999999958, 1087.999878000000081, 0, 0.0, 5904.255371000000196, 2112.0, 0, 0.0, 7180.851074000000153, 512.0, 0, -0.345, 10000.0, 0.0, 0, -0.7 ],
...
, 			{
				"box" : 				{
					...
					"text" : "poly~ tg.feeverb.2.2.Poly 1 args 1rev",
					"varname" : "poly~"
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-1.1::obj-1::obj-20" : [ "FilterInMode", "FilterInMode", 0 ],
			"obj-1.1::obj-1::obj-23" : [ "FilterInGain", "FilterInGain", 0 ],
			"obj-1.1::obj-1::obj-25" : [ "Tail", "Tail", 0 ],
			"obj-1.1::obj-1::obj-27" : [ "FilterInFreq", "FilterInFreq", 0 ],
			"obj-1.1::obj-1::obj-28" : [ "FilterInQ", "FilterInQ", 0 ],
...
, 			{
				...
				"bootpath" : "~/Desktop/_MODULES-master/EFFECTS/Reverb",
				"patcherrelativepath" : ".",
				"type" : "gDSP",
				"implicit" : 1
			}
...
, 			{
				"name" : "tg.feeverb.2.2.Poly.maxpat",
				"bootpath" : "~/Desktop/_MODULES-master/EFFECTS/Reverb",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
