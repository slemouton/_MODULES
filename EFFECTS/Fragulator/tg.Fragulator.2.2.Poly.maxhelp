...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 25.0, 37.0, 220.0, 98.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 112.0, 278.0, 36.0, 18.0 ],
					"text" : "Open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 112.0, 408.0, 133.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 112.0, 390.0, 41.0, 18.0 ],
					"text" : "Preset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 112.0, 329.0, 25.0, 18.0 ],
					"text" : "Init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 112.0, 347.0, 109.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 112.0, 296.0, 109.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 375.0, 75.0, 309.0, 64.0 ],
...
, 			{
				"box" : 				{
					"addpoints_with_curve" : [ 10.638297, -1.0101, 0, 0.0, 2925.531981999999971, 100.0, 0, 0.395, 3776.595702999999958, 45.333331999999999, 0, 0.0, 5904.255371000000196, 88.0, 0, 0.0, 7180.851074000000153, 21.333334000000001, 0, -0.345, 10000.0, 0.0, 0, -0.7 ],
...
, 			{
				"box" : 				{
					...
					"text" : "poly~ tg.Fragulator.2.2.Poly 1 args 1fra",
					"varname" : "poly~"
				}
...
, 			{
				...
				"bootpath" : "~/Desktop/_MODULES-master/EFFECTS/Fragulator",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "tg.Fragulator.2.2.Poly.maxpat",
				"bootpath" : "~/Desktop/_MODULES-master/EFFECTS/Fragulator",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
