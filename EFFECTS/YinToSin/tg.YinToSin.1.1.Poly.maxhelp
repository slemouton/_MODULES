...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 121.0, 483.5, 175.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 121.0, 591.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 121.0, 621.5, 184.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 121.0, 554.5, 158.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 121.0, 518.5, 161.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 121.0, 417.0, 133.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 121.0, 450.5, 142.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 121.0, 356.0, 109.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 121.0, 301.0, 109.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 375.0, 75.0, 278.0, 53.0 ],
...
, 			{
				"box" : 				{
					"addpoints_with_curve" : [ 10.638297, -24.484848, 0, 0.0, 2925.531981999999971, 24.0, 0, 0.395, 3776.595702999999958, -2.24, 0, 0.0, 5904.255371000000196, 18.240002, 0, 0.0, 7180.851074000000153, -13.759999000000001, 0, -0.345, 10000.0, -24.0, 0, -0.7 ],
...
, 			{
				"box" : 				{
					...
					"lockedsize" : 0,
					"maxclass" : "bpatcher",
					"name" : "FMA.slm.SoundPlayer~.maxpat",
					"numinlets" : 2,
					"numoutlets" : 5,
					"offset" : [ 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 18.0, 218.0, 151.0, 31.0 ],
					"text" : "poly~ tg.YinToSin.1.1.Poly 1 args 1Ysin",
					"varname" : "poly~"
				}
...
, 			{
				...
				"bootpath" : "~/Projets/MAXMSPStuff/Goepfer/_MODULES/EFFECTS/YinToSin",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "tg.YinToSin.1.1.maxpat",
				"bootpath" : "~/Projets/MAXMSPStuff/Goepfer/_MODULES/EFFECTS/YinToSin",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
