...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 18.0, 62.0, 228.0, 94.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"text" : ";\r1giz.storage recall Test1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 375.0, 75.0, 305.0, 98.0 ],
					"text" : ";\r1giz 1delay 10., 1feed 0.1, 1gain 0., 1pan -1., 1shift 0., 1trans -1200., 2delay 100., 2feed 0.3, 2gain 0., 2pan -0.33, 2shift 0., 2trans 1200., 3delay 333., 3feed 0.5, 3gain 0., 3pan 0.33, 3shift 0., 3trans -600., 4delay 555., 4feed 0.8, 4gain 0., 4pan 1., 4shift 0., 4trans 600., Clear 0., Delay 0., Dry/wet 100., Feedback 0., FilterFreq 745.731323, FilterGain 21.682108, FilterMode 8., FilterQ 0.079001, Ingain 0., Outgain 0.,"
				}
...
, 			{
				"box" : 				{
					"addpoints_with_curve" : [ 10.638297, -24.242401000000001, 0, 0.0, 2925.531981999999971, 2400.0, 0, 0.395, 3776.595702999999958, 1088.0, 0, 0.0, 5904.255371000000196, 2112.0, 0, 0.0, 7180.851074000000153, 512.0, 0, -0.345, 10000.0, 0.0, 0, -0.7 ],
...
, 			{
				"box" : 				{
					...
					"text" : "poly~ tg.GizmoX4.2.2.Poly 1 args 1giz",
					"varname" : "poly~"
				}
...
,
				"obj-1.1::obj-5::obj-158" : 				{
					"parameter_longname" : "Feedbacks",
					"parameter_shortname" : "Feedbacks"
				}
,
				"obj-1.1::obj-5::obj-159" : 				{
					"parameter_longname" : "2freq",
					"parameter_shortname" : "2freq"
				}
,
				"obj-1.1::obj-5::obj-172" : 				{
					"parameter_longname" : "3side",
					"parameter_shortname" : "3side"
				}
,
				"obj-1.1::obj-5::obj-173" : 				{
					"parameter_longname" : "3freq",
					"parameter_shortname" : "3freq"
				}
,
				"obj-1.1::obj-5::obj-186" : 				{
					"parameter_longname" : "Automate",
					"parameter_shortname" : "Automate"
				}
,
				"obj-1.1::obj-5::obj-187" : 				{
					"parameter_longname" : "4freq",
					"parameter_shortname" : "4freq"
				}
,
				"obj-1.1::obj-5::obj-28" : 				{
...
, 			{
				"name" : "tg.GizmoX4.2.2.Poly.maxpat",
				"bootpath" : "~/Desktop/_MODULES-master/EFFECTS/GizmoX4",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "tg.GizmoX4.2.2.maxpat",
				"bootpath" : "~/Desktop/_MODULES-master/EFFECTS/GizmoX4",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
